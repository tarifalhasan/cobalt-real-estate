...
import { ActiveListingData, SoldListData } from '@/data';
import assets1 from '@/assets/images/Asset.png';
import assets2 from '@/assets/images/Asset1.png';
const ProfilePage = () => {
  return (
    <section>
      <Container>
        ...
        <div className="relative">
          <div className=" relative z-20 pt-40 flex flex-col lg:flex-row   gap-6">
            <div className="  basis-[30%]">
              <div className=" px-4  py-6 profile_card">
                <div className="avatar">
                  <Image
                    className=" w-full  mx-auto h-full max-w-[180px] max-h-[180px] rounded-full"
                    src={image}
                    alt="Sdsdsd"
                  />
                </div>
                ...
                <ul className=" pt-4 space-y-2">
                  ...
                  <li className=" flex items-center gap-2">
                    <HomeIcon />
                    <span className=" text-sm uppercase">SOLD 43 BASES</span>
                  </li>
                  <li className=" flex items-center gap-2">
                    <CameraIcon />
                    <span className=" text-sm uppercase">MADE $450 TOTAL</span>
                  </li>
                </ul>
                <button className=" mt-4 w-full bg-rust-red font-bold py-2.5 sm:py-4 text-base uppercase rounded-2xl">
                  REPORT
                </button>
              </div>
            </div>
            <div className=" space-y-4 basis-[70%]">
              {/* Reviews */}
              <Reviews titleFontSize="text-xl lg:text-2xl 2xl:text-5xl" />
              {/* ACTIVE LISTINGS */}

              <div className=" pt-10 relative">
                <h4 className=" italic text-xl sm:text-5xl font-bold">
                  SOLD LISTINGS
                </h4>

                {/* Assets */}
                <div className=" absolute left-[62%] top-[7%]">
                  <Image src={assets2} alt="assets" />
                </div>
                <div className=" pt-7 grid md:grid-cols-2 gap-5 xl:grid-cols-3">
                  {ActiveListingData.map((data, key) => (
                    <ListingPreview
          ...
          {/* Assets */}
          <div className="  hidden lg:block lg:top-[23%] xl:top-[34%] 2xl:top-[31%] left-[26%] absolute">
